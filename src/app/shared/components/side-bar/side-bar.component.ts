...
import { SidebarServiceService } from '../../../services/SidebarService/sidebar-service.service';
...
export class SideBarComponent implements OnInit {
  ...
  // Admin Menu
  adminMenu: MenuItem[] = [
    { label: 'Dashboard', icon: 'ic:sharp-dashboard', route: '/admin/dashboard' }
  ];

  // Registrar Menu
  registrarMenu: MenuItem[] = [
    { label: 'Dashboard', icon: 'ic:sharp-dashboard', route: '/registrar/dashboard' }
  ];

  // Accounting Menu
  accountingMenu: MenuItem[] = [
    { label: 'Dashboard', icon: 'ic:sharp-dashboard', route: '/accounting/dashboard' }
  ];

  // Cashier Menu
  cashierMenu: MenuItem[] = [
    { label: 'Dashboard', icon: 'ic:sharp-dashboard', route: '/cashier/dashboard' }
  ];
  ...
  setMenuByRole() {
    const userRole = localStorage.getItem('userRole') as 'admin' | 'accounting' | 'registrar' | 'cashier';
    ...
    switch (userRole) {
      case 'admin':
        ...
        break;
      case 'registrar':
        this.currentMenu = [...this.registrarMenu];
        break;
      case 'accounting':
        this.currentMenu = [...this.accountingMenu];
        break;
      case 'cashier':
        this.currentMenu = [...this.cashierMenu];
        break;
      default:
    ...
    // Add the general menu for all users
